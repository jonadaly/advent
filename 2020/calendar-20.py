...
def match_tile(original_tile: Tile, original_edge: str, all_tiles: Dict[int, Tile]) -> Tile:
    """
...
# COLUMNS
for i_row in range(1, l):
    for i_col in range(l):
...
image_rows = []
for i_row in range(l):
    row_of_tiles = [tiles[tile_positions[i_row,i]].elements[1:9,1:9] for i in range(l)]
